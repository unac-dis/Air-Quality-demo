                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            AlertDialog.Builder dialogo1 = new AlertDialog.Builder(GoogleSignInActivity.this);
                            ...
                            dialogo1.setPositiveButton("Ingresar", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialogo1, int id) {
                                    Intent intent = new Intent(GoogleSignInActivity.this, Navigationdrawer.class);
